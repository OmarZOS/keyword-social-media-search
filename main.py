...
from twitter_scrapper import  graph_to_json, process_data, publish_data, save_json, search_twitter

# list_of_trends = ['ميلة dz']
...
async def assigner(tasks):
    ...
    while task_n < TASK_LIMIT :
        
        keyword = get_session(CONTEXT_URL).get(TWITTER_NEXT_KEYWORD)
